interface TKDrawing extends NSObjectProtocol {
	...
	drawInContextWithRect(context: any, rect: any): void;
}
...
declare const TKLayoutOrientationHorizontal: TKLayoutOrientation;
declare const TKLayoutOrientationVertical: TKLayoutOrientation;
...
declare class TKFill extends NSObject implements TKDrawing {
	...
	drawFillInContextWithRect(context: any, rect: any): void;
	drawInContextWithPath(context: any, path: any): void; // inherited from TKDrawing
	drawInContextWithRect(context: any, rect: any): void; // inherited from TKDrawing
	init(): TKFill; // inherited from NSObject
	self(): TKFill; // inherited from NSObjectProtocol
}
declare class TKStroke extends NSObject implements TKDrawing {
...
declare class TKLabel extends UILabel {
	...
	initWithCoder(aDecoder: any): TKLabel; // inherited from NSCoding
	textColor: UIColor; //inherited from UILabel
	font: UIFont; //inherited from UILabel
}
...
declare class TKView extends UIView {
	...
	shape: any;//TKShape;
	stroke: TKStroke;
	initWithCoder(aDecoder: any): TKView; // inherited from NSCoding
	initWithFrame(frame: any): TKView; // inherited from UIView
...
declare class TKEntity extends NSObject {
	...
	validate(): NSArray;
	writeJSONToStream(outputStream: any): NSError;
...
declare class TKEntityPropertyGroupEditorsView extends UIView {
	...
	initWithCoder(aDecoder: any): TKEntityPropertyGroupEditorsView; // inherited from NSCoding
	initWithFrame(frame: any): TKEntityPropertyGroupEditorsView; // inherited from UIView
	removeAllItems(): void;
...
declare class TKEntityPropertyGroupTitleView extends UIView {
	...
	titleLabel: TKLabel;
	hidden: boolean;
	initWithCoder(aDecoder: any): TKEntityPropertyGroupTitleView; // inherited from NSCoding
	initWithFrame(frame: any): TKEntityPropertyGroupTitleView; // inherited from UIView
...
declare class TKEntityPropertyGroupTitleViewIndicator extends UIView {
	...
	initWithCoder(aDecoder: any): TKEntityPropertyGroupTitleViewIndicator; // inherited from NSCoding
	initWithFrame(frame: any): TKEntityPropertyGroupTitleViewIndicator; // inherited from UIView
...
declare class TKEntityPropertyGroupView extends UIView {
	...
	initWithCoder(aDecoder: any): TKEntityPropertyGroupView; // inherited from NSCoding
	initWithFrame(frame: any): TKEntityPropertyGroupView; // inherited from UIView
...
declare class TKDataForm extends UIView {
	...
	commit(): void;
	initWithCoder(aDecoder: any): TKDataForm; // inherited from NSCoding
	initWithFrame(frame: any): TKDataForm; // inherited from UIView
	...
	update(): void;
	groupViewForGroup(value: TKEntityPropertyGroup): TKEntityPropertyGroupView;
	updateEditorForProperty(value: TKEntityProperty): void;
	setupWithJSONAnnotationsString(value: string): void;
}
...
declare class TKDataFormAccessoryView extends UIView {
	...
	toolbar: UIToolbar;
	initWithCoder(aDecoder: any): TKDataFormAccessoryView; // inherited from NSCoding
	initWithFrame(frame: any): TKDataFormAccessoryView; // inherited from UIView
...
declare class TKDataFormMultilineTextEditor extends TKDataFormTextFieldEditor {
}
...
declare class TKDataFormEditor extends UIView {
	...
	static class(): typeof NSObject; // inherited from NSObjectProtocol
	editor: UIView;
	...
	textLabel: TKLabel;
	value: any;
	initWithCoder(aDecoder: any): TKDataFormEditor; // inherited from NSCoding
	initWithFrame(frame: any): TKDataFormEditor; // inherited from UIView
	initWithProperty(property: TKEntityProperty): TKDataFormEditor;
	self(): TKDataFormEditor; // inherited from NSObjectProtocol
	setNeedsDisplay(): void; // inherited from UIView
	setNeedsLayout(): void; // inherited from UIView
	update(): void;
}

declare class TKDataFormEditorStyle extends NSObject {
	accessoryArrowSize: any;
...
declare class TKDataFormOptionsViewController extends UITableViewController {
	...
	items: NSArray;
	initWithStyle(style: any): TKDataFormOptionsViewController; // inherited from UITableViewController
...
declare class TKDataFormViewController extends UIViewController implements TKDataFormDataSource, TKDataFormDelegate {
	...
	indexOfGroupInDataForm(group: TKEntityPropertyGroup): number; // inherited from TKDataFormDataSource
	initWithCoder(aDecoder: any): TKDataFormViewController; // inherited from NSCoding
	initWithNibNameBundle(nibNameOrNil: string, nibBundleOrNil: any): TKDataFormViewController; // inherited from UIViewController
...
declare class UITraitCollection extends NSObject {
}

declare class UIResponder extends NSObject {
}

declare class NSError extends NSObject {
}
...
declare class UIDatePicker extends UIView {
}

declare class UIStepper extends UIView {
	stepValue: number;
	minimumValue: number;
	maximumValue: number;
}
...
declare class UIPickerView extends UIView {
}

declare class UISegmentedControl extends UIView {
}
...
declare class UIBarButtonItem extends UIView {
}

declare class UIToolbar extends UIView {
}

declare class UIFont extends UIResponder {
	static systemFontOfSize(size: number): UIFont;
	static fontWithDescriptorSize(description: UIFontDescriptor, size: number): UIFont;
	static fontWithNameSize(name: string, size: number);
	fontDescriptor: UIFontDescriptor;
}

declare class UIFontDescriptor extends NSObject {
	fontDescriptorWithSymbolicTraits(traits: UIFontDescriptorSymbolicTraits): UIFontDescriptor;
}

declare class UIColor extends NSObject {
}

declare class UIImage extends NSObject {
	static imageNamed(value: string): UIImage;
}
...
declare class NSMutableArray extends NSArray {
	...
	initWithCapacity(value: number): NSMutableArray;
